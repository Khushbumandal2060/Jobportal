...
$sql = "SELECT COUNT(*) AS job_seekers FROM users WHERE role = 'job_seeker'";
$result = mysqli_query($conn, $sql);
$job_seekers = mysqli_fetch_assoc($result)['job_seekers'];

// Total number of employers
$sql = "SELECT COUNT(*) AS employers FROM users WHERE role = 'employer'";
$result = mysqli_query($conn, $sql);
$employers = mysqli_fetch_assoc($result)['employers'];

// Total number of job postings
$sql = "SELECT COUNT(*) AS jobs FROM jobs";
$result = mysqli_query($conn, $sql);
